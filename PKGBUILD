...
_srcname=${_srctag}
pkgdesc="okhsunrog's personal LTS kernel: CachyOS base + i915/xe RC6 modparam patches for MTL GPU hang workaround + ZFS built-in"
